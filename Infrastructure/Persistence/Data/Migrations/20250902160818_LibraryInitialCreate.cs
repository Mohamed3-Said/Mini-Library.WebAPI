    ...
    public partial class LibraryInitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBorrows", x => x.UserBorrowId);
                    table.ForeignKey(
                        name: "FK_UserBorrows_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBorrows_Users_UserSSN",
                        column: x => x.UserSSN,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBorrows_BookId",
                table: "UserBorrows",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBorrows_UserSSN",
                table: "UserBorrows",
                column: "UserSSN");
